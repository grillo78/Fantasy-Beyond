...
public class HumanEyes extends HumanCharacteristic implements Coloreable {

    private boolean renderingIris = false;
    private Color color = new Color(105, 18, 18,255);

    public HumanEyes(PlayerCustomization playerCustomization, String name, int maxVariants) {
