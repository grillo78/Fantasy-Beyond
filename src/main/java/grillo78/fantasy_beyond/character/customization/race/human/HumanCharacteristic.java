...
public class HumanCharacteristic extends Characteristic {
    ...
    public ResourceLocation getTexture(LivingEntity player){
        ResourceLocation baseTexture = ResourceLocation.fromNamespaceAndPath(FantasyBeyond.MOD_ID, "textures/entity/customization/race/human/" + name + "/" + (getPlayerCustomization().isMale() ? "male_" : "female_") + getVariant() + ".png");
