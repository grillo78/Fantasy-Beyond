...
public class MaleTieflingModel<T extends Entity> extends CustomizationModel<T> {
	...
	public MaleTieflingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer(CubeDeformation cubeDeformation) {
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(56, 24).addBox(-4.0F, -3.0F, 0.0F, 4.0F, 5.0F, 0.0F, cubeDeformation), PartPose.offsetAndRotation(-4.0F, -3.0F, 0.0F, 0.0F, 0.8727F, 0.0F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(56, 19).addBox(0.0F, -3.0F, 0.0F, 4.0F, 5.0F, 0.0F, cubeDeformation), PartPose.offsetAndRotation(4.0F, -3.0F, 0.0F, 0.0F, -0.8727F, 0.0F));
