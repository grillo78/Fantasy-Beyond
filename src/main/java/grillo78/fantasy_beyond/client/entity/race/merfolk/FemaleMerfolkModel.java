package grillo78.fantasy_beyond.client.entity.race.merfolk;
...
public class FemaleMerfolkModel<T extends Entity> extends CustomizationModel<T> {
	...
	public FemaleMerfolkModel(ModelPart root) {
	...
	public void copyFrom(CustomizationModel model) {
		root.copyFrom(((FemaleMerfolkModel) model).root);
		body.copyFrom(((FemaleMerfolkModel) model).body);
		right_leg.copyFrom(((FemaleMerfolkModel) model).right_leg);
		left_leg.copyFrom(((FemaleMerfolkModel) model).left_leg);
		head.copyFrom(((FemaleMerfolkModel) model).head);
		left_arm.copyFrom(((FemaleMerfolkModel) model).left_arm);
		right_arm.copyFrom(((FemaleMerfolkModel) model).right_arm);
	}
	...
	public static LayerDefinition createBodyLayer(CubeDeformation cubeDeformation) {
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(78, 8).addBox(0.0F, 0.0F, 0.0F, 4.0F, 5.0F, 3.0F, cubeDeformation.extend(0.25F))
				.texOffs(64, 8).addBox(0.0F, 0.0F, 0.0F, 4.0F, 5.0F, 3.0F, cubeDeformation), PartPose.offsetAndRotation(0.0F, 1.0F, -1.5F, -0.436F, -0.0184F, -0.0395F));
		...
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(78, 0).addBox(-4.0F, 0.0F, 0.0F, 4.0F, 5.0F, 3.0F, cubeDeformation.extend(0.25F))
				.texOffs(64, 0).addBox(-4.0F, 0.0F, 0.0F, 4.0F, 5.0F, 3.0F, cubeDeformation), PartPose.offsetAndRotation(0.0F, 1.0F, -1.5F, -0.436F, 0.0184F, 0.0395F));
		...
		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(52, 25).addBox(-6.0F, -3.0F, 0.0F, 6.0F, 5.0F, 0.0F, cubeDeformation), PartPose.offsetAndRotation(-4.0F, -3.0F, 0.0F, 0.0F, 0.3491F, 0.0F));

		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(52, 20).addBox(0.0F, -3.0F, 0.0F, 6.0F, 5.0F, 0.0F, cubeDeformation), PartPose.offsetAndRotation(4.0F, -3.0F, 0.0F, 0.0F, -0.3491F, 0.0F));
