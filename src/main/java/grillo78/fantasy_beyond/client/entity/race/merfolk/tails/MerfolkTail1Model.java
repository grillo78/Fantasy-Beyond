...
public class MerfolkTail1Model<T extends Entity> extends CustomizationModel<T> {
    ...
    public MerfolkTail1Model(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = body.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(104, 0).addBox(-3.0F, -1.5F, 0.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.5F, 2.0F));

        PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(106, 9).addBox(-2.5F, -1.5F, 0.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 6.0F));

        PartDefinition bone3 = bone2.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(108, 18).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 6.0F));

        PartDefinition bone4 = bone3.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(104, 26).addBox(-3.0F, -1.0F, 0.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 6.0F));

        PartDefinition bone5 = bone4.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(96, 34).addBox(-5.0F, -0.5F, 0.0F, 10.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 6.0F));
    ...
    public void setupModel(HumanoidModel bipedModel, Player player, float partialTick) {
        ...
        bone5.setRotation((float) Math.toRadians(Math.cos(-Mth.lerp(partialTick, player.tickCount - 1, player.tickCount) / 5) * 7 - 7), (float) Math.toRadians(Math.sin(-Mth.lerp(partialTick, player.tickCount - 1, player.tickCount) / 2) * 3), (float) Math.toRadians(Math.sin(-Mth.lerp(partialTick, player.tickCount - 1, player.tickCount) / 5) * 20));
    }
