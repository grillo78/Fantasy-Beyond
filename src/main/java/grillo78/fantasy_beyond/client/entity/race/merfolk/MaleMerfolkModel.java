...
public class MaleMerfolkModel<T extends Entity> extends CustomizationModel<T> {
    ...
    public MaleMerfolkModel(ModelPart root) {
    ...
    public void copyFrom(CustomizationModel model) {
        root.copyFrom(((MaleMerfolkModel) model).root);
        body.copyFrom(((MaleMerfolkModel) model).body);
        right_leg.copyFrom(((MaleMerfolkModel) model).right_leg);
        left_leg.copyFrom(((MaleMerfolkModel) model).left_leg);
        head.copyFrom(((MaleMerfolkModel) model).head);
        left_arm.copyFrom(((MaleMerfolkModel) model).left_arm);
        right_arm.copyFrom(((MaleMerfolkModel) model).right_arm);
    }
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation cubeDeformation) {
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 7.0F, 4.0F, cubeDeformation)
                ...
                .texOffs(16, 46).addBox(-3.5F, 7.0F, -1.5F, 7.0F, 5.0F, 3.0F, cubeDeformation.extend(0.1F))
                .texOffs(16, 27).addBox(-3.5F, 7.0F, -1.5F, 7.0F, 5.0F, 3.0F, cubeDeformation.extend(0.35F)), PartPose.offset(0.0F, -1.0F, 0.0F));
        ...
        PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(56, 25).addBox(-6.0F, -3.0F, 0.0F, 6.0F, 5.0F, 0.0F, cubeDeformation), PartPose.offsetAndRotation(-4.0F, -3.0F, 0.0F, 0.0F, 0.3491F, 0.0F));

        PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(56, 20).addBox(0.0F, -3.0F, 0.0F, 6.0F, 5.0F, 0.0F, cubeDeformation), PartPose.offsetAndRotation(4.0F, -3.0F, 0.0F, 0.0F, -0.3491F, 0.0F));
        ...
        PartDefinition left_arm = root.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 55).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 13.0F, 4.0F, cubeDeformation)
                .texOffs(49, 55).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 13.0F, 4.0F, cubeDeformation.extend(0.25F)), PartPose.offset(5.0F, 1.0F, 0.0F));
