...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation TALL_HORNS = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(FantasyBeyond.MOD_ID, "tall_horns"), "main");
    ...
    public static final ModelLayerLocation GOBLIN = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(FantasyBeyond.MOD_ID, "goblin"), "main");
    public static final ModelLayerLocation MIMIC = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(FantasyBeyond.MOD_ID, "mimic"), "main");
