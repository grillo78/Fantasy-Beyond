...
public class GrimoireBEWLR extends BlockEntityWithoutLevelRenderer {
    public GrimoireBEWLR() {
    ...
    private BakedModel getModel(ItemStack stack) {
        ...
        return Minecraft.getInstance()
                .getModelManager()
                .getModel(new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(registryName.getNamespace(), "item/" + registryName.getPath() + "_model"), "standalone"));
    }
