...
public class BiggerStructure extends Structure {

    public static final Codec<BiggerStructure> CODEC = ExtraCodecs.validate(RecordCodecBuilder.mapCodec((p_227640_) -> {
        ...
        }), Codec.intRange(0, 100).fieldOf("size").forGetter((p_227652_) -> {
        ...
        }), Codec.intRange(1, 500).fieldOf("max_distance_from_center").forGetter((p_227642_) -> {
            return p_227642_.maxDistanceFromCenter;
        })).apply(p_227640_, BiggerStructure::new);
    }), BiggerStructure::verifyRange).codec();
    ...
    private static DataResult<BiggerStructure> verifyRange(BiggerStructure p_286886_) {
        byte b0;
        ...
        int i = b0;
        return p_286886_.maxDistanceFromCenter + i > 500 ? DataResult.error(() -> {
            return "Structure size including terrain adaptation must not exceed 128";
        }) : DataResult.success(p_286886_);
    }

    public BiggerStructure(StructureSettings p_227627_, Holder<StructureTemplatePool> p_227628_, Optional<ResourceLocation> p_227629_, int p_227630_, HeightProvider p_227631_, boolean p_227632_, Optional<Heightmap.Types> p_227633_, int p_227634_) {
        super(p_227627_);
    ...
    public BiggerStructure(StructureSettings pSettings, Holder<StructureTemplatePool> pStartPool, int pMaxDepth, HeightProvider pStartHeight, boolean pUseExpansionHack, Heightmap.Types pProjectStartToHeightmap) {
    ...
    public BiggerStructure(StructureSettings pSettings, Holder<StructureTemplatePool> pStartPool, int pMaxDepth, HeightProvider pStartHeight, boolean pUseExpansionHack) {
    ...
    public StructureType<?> type() {
        return ModStructures.BIGGER_STRUCTURE.get();
    }
}
