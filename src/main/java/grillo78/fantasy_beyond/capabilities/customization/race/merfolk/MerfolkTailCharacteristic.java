...
import grillo78.fantasy_beyond.capabilities.customization.race.merfolk.tails.MerfolkTail1;
import grillo78.fantasy_beyond.capabilities.customization.race.merfolk.tails.Tail;
import grillo78.fantasy_beyond.capabilities.customization.race.tiefling.TieflingCharacteristic;
...
public class MerfolkTailCharacteristic extends TieflingCharacteristic {
    ...
    public ResourceLocation getTexture(Player player) {
        ResourceLocation baseTexture = new ResourceLocation(FantasyBeyond.MOD_ID, "textures/entity/customization/race/merfolk/tails/" + getVariant() + ".png");
