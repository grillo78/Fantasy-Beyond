...
public class PixyEyes extends PixyCharacteristic implements Coloreable {

    private boolean renderingIris = false;
    private Color color = new Color(105, 18, 18,255);

    public PixyEyes(PlayerCustomization playerCustomization, String name, int maxVariants) {
