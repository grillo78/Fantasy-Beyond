...
public class MerfolkEyes extends MerfolkCharacteristic implements Coloreable {

    private boolean renderingIris = false;
    private Color color = new Color(105, 18, 18,255);

    public MerfolkEyes(PlayerCustomization playerCustomization, String name, int maxVariants) {
