...
public class TieflingCharacteristic extends Characteristic {
    ...
    public ResourceLocation getTexture(Player player) {
        ResourceLocation baseTexture =  new ResourceLocation(FantasyBeyond.MOD_ID, "textures/entity/customization/race/tiefling/" + name + "/" + (getPlayerCustomization().isMale() ? "male_" : "female_") + getVariant() + ".png");
